...
def storeVideoData(data):
    ...
    if created:
        print(f'[{script}]: Added "{video.idd}" data to library!') if verbosity>=3 else None
    else:
...
def housekeeping():
    '''
    Updates the entire video library. Should call tagger afterwards.
    '''
